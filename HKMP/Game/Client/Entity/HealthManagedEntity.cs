...
namespace Hkmp.Game.Client.Entity {
    ...
    public abstract class HealthManagedEntity : Entity {
        ...
        protected virtual void HealthManagerOnDieHook(On.HealthManager.orig_Die orig, HealthManager self, float? attackDirection, AttackTypes attackType, bool ignoreEvasion) {
            Logger.Get().Info(this, "HealthManagerOnDieHook was just invoked");
