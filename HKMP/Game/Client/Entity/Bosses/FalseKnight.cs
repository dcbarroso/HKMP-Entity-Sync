    ...
    public class FalseKnight : Entity {
        ...
        private void CreateAnimationEvents() {
            ...
            _fsm.InsertMethod("Recover", 0, CreateUpdateMethod(() => {
                ...
                Logger.Get().Info(this, "Recover State reached");
